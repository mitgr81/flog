...
class TestLogCall(unittest.TestCase):
    ...
    def test_log_call_logs(self, logging):
        ...
        actual = flog.log_call(self.logger)(my_fun)()  # SUT
    ...
    def test_log_call_logs_with_args(self, logging):
        ...
        actual = flog.log_call(self.logger)(my_fun)(randoa, randob, randoc)  # SUT

        self.logger.debug.assert_any_call("test_log_call.my_fun: args: ({}, {}, {}), kwargs: {}".format(randoa, randob, randoc, '{}'))
    ...
    def test_log_call_logs_with_kwargs(self, logging):
        ...
        actual = flog.log_call(self.logger)(my_fun)(randoa, randob, randoc, random_frippery_scale=32)  # SUT

        self.logger.debug.assert_any_call("test_log_call.my_fun: args: ({}, {}, {}), kwargs: {rfs}".format(randoa, randob, randoc, rfs="{'random_frippery_scale': 32}"))
        self.logger.debug.assert_any_call("test_log_call.my_fun: returns: {}".format(randoa + randob + randoc))
    ...
    def test_log_call_logs_instance_method_with_kwargs(self, logging):
        ...
        actual = flog.log_call(self.logger)(self.instance_method)(randoa, randob, randoc, random_frippery_scale=32)  # SUT

        self.logger.debug.assert_any_call("test_log_call.TestLogCall.instance_method: args: ({}, {}, {}), kwargs: {rfs}".format(randoa, randob, randoc, rfs="{'random_frippery_scale': 32}"))
        self.logger.debug.assert_any_call("test_log_call.TestLogCall.instance_method: returns: {}".format(randoa + randob + randoc))
...
class TestLogSensitiveCall(unittest.TestCase):
    ...
    def test_log_call_logs(self, logging):
        ...
        actual = flog.log_sensitive_call(self.logger)(my_fun)()  # SUT
    ...
    def test_log_call_logs_with_args(self, logging):
        ...
        actual = flog.log_sensitive_call(self.logger)(my_fun)(randoa, randob, randoc)  # SUT
    ...
    def test_log_call_logs_with_kwargs(self, logging):
        ...
        actual = flog.log_sensitive_call(self.logger)(my_fun)(randoa, randob, randoc, random_frippery_scale=32)  # SUT
